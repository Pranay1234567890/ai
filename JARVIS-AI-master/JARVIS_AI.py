...
def wishMe():
    ...
    speak("Your AI assistant at your Service. Please tell me how can I help You ")
#wishMe()
def takeCommand():
    ...
    try:
        ...
        print(f"J.Pranay kumar Said:{query}\n")
...
def lighton():
    driver = webdriver.Chrome('C:/sers/HP/python/JARVIS-AI-master/chromedriver.exe')
